...
document.querySelector('#app').innerHTML = `
  <!-- Sidebar Navigation -->
  <aside id="sidebar" class="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col h-full z-50 shadow-sm fixed md:static transform -translate-x-full md:translate-x-0 transition-all duration-300 ease-in-out">
    <div class="h-16 flex items-center px-6 border-b border-slate-100 dark:border-slate-800 transition-colors duration-300">
      ...
      <h1 class="text-lg font-bold text-slate-800 dark:text-slate-100 tracking-tight transition-colors duration-300">EDI Validator</h1>
    </div>
  ...
  <!-- Main Content Area -->
  <main class="flex-1 flex flex-col h-full overflow-y-auto bg-slate-50/50 dark:bg-slate-900 relative transition-colors duration-300">
    <!-- Top Header -->
    <header class="h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 md:px-8 z-10 sticky top-0 shadow-sm transition-colors duration-300">
      <div class="flex items-center">
        ...
        <h2 id="topbar-title" class="text-xl font-bold text-slate-800 dark:text-slate-100 transition-colors duration-300">Dashboard</h2>
      </div>
    ...
    <div id="workspace" class="flex-1 overflow-y-auto p-4 md:p-8 relative">
       ...
       <section id="view-dashboard" class="view-section animate-fade-in block">
          ...
          <div class="flex justify-between items-end mb-8">
            <div>
              <p class="text-slate-500 text-sm mb-1">Overview</p>
              <h3 class="text-2xl font-bold text-slate-800">EDI Performance</h3>
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="card dark:bg-slate-800 dark:border-slate-700 animate-fade-in hover:shadow-md transition-shadow relative overflow-hidden group">
              <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <svg class="w-16 h-16 text-blue-600 dark:text-blue-500" fill="currentColor" viewBox="0 0 20 20"><path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" /><path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd" /></svg>
              </div>
              <div class="flex items-center text-slate-500 dark:text-slate-400 mb-4 transition-colors duration-300">
                ...
                <h3 class="font-medium">Total Claims</h3>
              </div>
              <h2 id="claimsCount" class="text-3xl font-bold text-slate-800 dark:text-slate-100 transition-colors duration-300">0</h2>
            ...
            <div class="card dark:bg-slate-800 dark:border-slate-700 animate-fade-in animate-delay-100 hover:shadow-md transition-shadow relative overflow-hidden group">
               <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
              ...
              <div class="flex items-center text-slate-500 dark:text-slate-400 mb-4 transition-colors duration-300">
                ...
                <h3 class="font-medium">Total Billed</h3>
              </div>
              <h2 id="totalBilled" class="text-3xl font-bold text-slate-800 dark:text-slate-100 transition-colors duration-300">$0.00</h2>
            ...
            <div class="card dark:bg-slate-800 dark:border-slate-700 animate-fade-in animate-delay-200 hover:shadow-md transition-shadow relative overflow-hidden group">
               <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
              ...
              <div class="flex items-center text-slate-500 dark:text-slate-400 mb-4 transition-colors duration-300">
                ...
                <h3 class="font-medium">Total Paid</h3>
              </div>
              <h2 id="totalPaid" class="text-3xl font-bold text-slate-800 dark:text-slate-100 transition-colors duration-300">$0.00</h2>
            ...
            <div class="card dark:bg-slate-800 dark:border-slate-700 animate-fade-in animate-delay-300 hover:shadow-md transition-shadow relative overflow-hidden group">
               <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
              ...
              <div class="flex items-center text-slate-500 dark:text-slate-400 mb-4 transition-colors duration-300">
                ...
                <h3 class="font-medium">Patient Resp.</h3>
              </div>
              <h2 id="patientResp" class="text-3xl font-bold text-slate-800 dark:text-slate-100 transition-colors duration-300">$0.00</h2>
          ...
          <!-- Table -->
          <div class="card p-0 overflow-hidden animate-fade-in animate-delay-400 dark:bg-slate-800 dark:border-slate-700">
            <div class="px-6 py-5 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-white dark:bg-slate-800 transition-colors duration-300">
              <h3 class="font-bold text-slate-800 dark:text-slate-100 text-lg transition-colors duration-300">Recent Files</h3>
              <button class="text-sm text-blue-600 dark:text-blue-400 font-medium hover:text-blue-700 dark:hover:text-blue-300 transition">View All</button>
            </div>
            <div class="overflow-x-auto">
              <table class="w-full text-left text-sm whitespace-nowrap">
                <thead class="bg-slate-50 dark:bg-slate-900/50 text-slate-500 dark:text-slate-400 font-medium transition-colors duration-300">
                  <tr>
                    <th class="px-6 py-4 border-b border-slate-100 dark:border-slate-700">File Name</th>
                    <th class="px-6 py-4 border-b border-slate-100 dark:border-slate-700">Transaction Type</th>
                    <th class="px-6 py-4 border-b border-slate-100 dark:border-slate-700">Upload Time</th>
                    <th class="px-6 py-4 border-b border-slate-100 dark:border-slate-700">Status</th>
                    <th class="px-6 py-4 border-b border-slate-100 dark:border-slate-700 text-right">Action</th>
                  </tr>
                </thead>
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700 bg-white dark:bg-slate-800 group/list transition-colors duration-300">
       ...
       <section id="view-upload" class="view-section hidden animate-fade-in text-center h-full flex flex-col justify-center max-w-2xl mx-auto py-12">
          <h2 class="text-3xl font-bold text-slate-800 dark:text-slate-100 mb-2 transition-colors duration-300">Upload EDI File</h2>
        ...
        <section id="view-parsed" class="view-section hidden animate-fade-in max-w-7xl mx-auto py-8">
          <div class="flex justify-between items-end mb-6">
             <div>
               <h2 class="text-2xl font-bold text-slate-800 dark:text-slate-100 transition-colors duration-300">Parsed EDI Structure</h2>
         ...
         <div class="flex flex-col lg:flex-row gap-6">
           ...
           <div id="segment-details-panel" class="w-full lg:w-96 card p-0 shadow-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hidden flex-col animate-slide-up sticky top-24 self-start">
             <div class="p-4 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 flex justify-between items-center transition-colors duration-300">
       ...
       <section id="view-validation" class="view-section hidden animate-fade-in w-full px-4 sm:px-6 lg:px-8 py-8">
         ...
         <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
             <div id="validationTable" class="lg:col-span-5 transition-all duration-300 card p-0 overflow-hidden shadow-sm bg-white dark:bg-gray-800 rounded-xl shadow">
                <div class="w-full overflow-x-auto">
                   <table class="min-w-[700px] w-full text-sm text-gray-700 dark:text-gray-200 text-left">
                      <thead class="bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 font-medium">
                     <tr>
               ...
               <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                  <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300 group cursor-pointer relative">
             ...
             <div id="fixDetails" class="hidden lg:col-span-2 card p-0 shadow-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex-col animate-fade-in transition-all duration-300 ease-in-out lg:sticky lg:top-6 self-start max-h-[90vh] overflow-y-auto">
       ...
       <section id="view-summary" class="view-section hidden animate-fade-in max-w-5xl mx-auto py-8">
         <div class="flex justify-between items-end mb-6">
            <div>
              <h2 class="text-2xl font-bold text-slate-800">837 Claims Summary</h2>
         ...
         <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="card shadow-sm border-l-4 border-l-green-500">
               <p class="text-slate-500 font-medium mb-1">Total Claims</p>
               <h3 class="text-3xl font-bold text-slate-800">124</h3>
            </div>
            <div class="card shadow-sm border-l-4 border-l-teal-500">
               <p class="text-slate-500 font-medium mb-1">Unique Providers</p>
               <h3 class="text-3xl font-bold text-slate-800">12</h3>
            </div>
         </div>
         <div class="card p-0 shadow-sm overflow-hidden">
            <h3 class="px-6 py-4 bg-slate-50 border-b border-slate-100 font-bold text-slate-700">Top Providers by Volume</h3>
            <div class="p-6">
               <div class="space-y-4">
                  <div>
                     <div class="flex justify-between text-sm mb-1">
                        <span class="font-medium text-slate-700">General Hospital Medical Center</span>
                        <span class="text-slate-500">$18,450.00</span>
                     </div>
                  ...
                  <div>
                     <div class="flex justify-between text-sm mb-1">
                        <span class="font-medium text-slate-700">Dr. Smith Clinic</span>
                        <span class="text-slate-500">$12,120.50</span>
                     </div>
                     <div class="w-full bg-slate-100 rounded-full h-2">
                  ...
                  <div>
                     <div class="flex justify-between text-sm mb-1">
                        <span class="font-medium text-slate-700">Westside Cardiology</span>
                        <span class="text-slate-500">$8,200.75</span>
                     </div>
                     <div class="w-full bg-slate-100 rounded-full h-2">
       ...
       <section id="view-assistant" class="view-section hidden animate-fade-in max-w-4xl mx-auto py-4 h-[calc(100vh-8rem)] flex flex-col">
         <div class="flex items-center mb-6">
           <div class="w-12 h-12 rounded-xl bg-teal-100 text-teal-600 flex items-center justify-center mr-4 shadow-sm">
             <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
           </div>
           <div>
             <h2 class="text-2xl font-bold text-slate-800">EDI AI Assistant</h2>
             <p class="text-slate-500 text-sm mt-0.5">Ask questions about EDI formats, errors, or your specific claims.</p>
           </div>
         </div>
         
         <div class="card flex-1 flex flex-col bg-white overflow-hidden p-0">
           <!-- Chat messages -->
           <div class="flex-1 overflow-y-auto p-6 space-y-6" id="chat-messages">
              ...
              <div class="flex items-start">
                 ...
                 <div class="bg-slate-50 border border-slate-100 rounded-2xl p-4 text-sm text-slate-700 shadow-sm rounded-tl-none max-w-[80%] inline-block">
                    Hello! I'm your EDI AI Assistant. I can help explain validation errors, decipher X12 segments, or summarize your data.
                    <br><br>
                    Try asking:
              ...
              <div class="flex items-start animate-fade-in animate-delay-400">
                 ...
                 <div class="bg-slate-50 border border-slate-100 rounded-2xl p-4 text-sm text-slate-700 shadow-sm rounded-tl-none max-w-[80%] inline-block">
                    ...
                    <code class="block bg-slate-800 text-slate-300 p-2 rounded my-2 font-mono text-xs">N4*CHICAGO*IL*~</code>
                    ...
                    <p class="mt-2 text-teal-700 font-medium">Suggested Fix: Add the proper 5 or 9 digit zip code, e.g., N4*CHICAGO*IL*60601~</p>
                 </div>
              </div>
           </div>
...
if (dropZone) {
  ...
  function handleFiles(files) {
    ...
    reader.onload = function (e) {
      ...
      // Parse segments dynamically based on tilde separator
      ...
      const errors = validateEDI(segments, transType);

      // Update the UI Table with actual issues
      window.updateValidationReportUI(errors, file.name, transType);

      // Update the Parsed Data Viewer UI with actual segments
      window.updateParsedDataUI(segments, transType, file.name);

      // Extract and Store Claim Summary for Dashboard
      window.calculateCLPSummary(ediContent);
      window.updateDashboardSummaryUI();

      // Mock delay to simulate backend parsing & validation
      setTimeout(() => {
        loadingContent.classList.add('hidden');
        loadingContent.classList.remove('flex');
        uploadContent.classList.remove('hidden');

        // Show validation view upon successful read instead of parsed view
...
window.updateParsedDataUI = function (segments, transType, fileName) {
  ...
  function makeElement(segData, isWrapper = false) {
    ...
    if (isWrapper) {
      return `
                <div class="flex items-center group cursor-pointer p-2 hover:bg-slate-50 rounded-lg border border-transparent hover:border-slate-100 transition-colors" onclick="window.showSegmentDetails('${segId}')">
                    ...
                    <div class="relative group/tooltip inline-block ml-2" onclick="event.stopPropagation(); window.showSegmentDetails('${segId}')">
                         <svg class="w-4 h-4 text-slate-300 hover:text-blue-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                         <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-slate-800 text-white text-xs rounded shadow-lg opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-all z-10 pointer-events-none text-center transform translate-y-2 group-hover/tooltip:translate-y-0 text-sans font-normal whitespace-normal w-max max-w-xs">
    ...
    return `
            <div class="flex items-center p-1.5 hover:bg-slate-50 rounded text-xs cursor-pointer group/line" onclick="window.showSegmentDetails('${segId}')">
                ...
                <div class="relative group/tooltip inline-block ml-2 hidden group-hover/line:inline-block" onclick="event.stopPropagation(); window.showSegmentDetails('${segId}')">
                    <svg class="w-4 h-4 text-slate-300 hover:text-blue-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-slate-800 text-white text-xs rounded shadow-lg opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-all z-10 pointer-events-none text-center transform translate-y-2 group-hover/tooltip:translate-y-0 text-sans font-normal whitespace-normal w-max max-w-xs">
                        ${def.title}
                    </div>
  ...
  segments.forEach(seg => {
    ...
    if (!['ISA', 'GS', 'ST'].includes(segId)) {
      innerHtml += `<li class="relative before:content-[''] before:absolute before:-left-4 before:top-3 before:w-4 before:h-px before:bg-slate-200">
                ${makeElement(seg, false)}
            </li>`;
    }
  });

  const isa = segments.find(s => s.startsWith('ISA')) || 'ISA*';
  const gs = segments.find(s => s.startsWith('GS')) || 'GS*';
  const st = segments.find(s => s.startsWith('ST')) || 'ST*';

  treeContainer.innerHTML = `
        <li>
            ${makeElement(isa, true)}
  ...
  // Show segment details of the first segment by default to look nice
  if (segments.length > 0) {
    window.showSegmentDetails(segments[0].split('*')[0] || 'ISA');
  }
}
...
function detectTransactionType(segments) {
  ...
  if (st.includes("837")) return "837";
  if (st.includes("835")) return "835";
  if (st.includes("834")) return "834";
  return "unknown";
}

function validateEDI(segments, type) {
  const errors = [];

  if (type === "835") {
    if (!segments.some(s => s.startsWith("BPR"))) {
      errors.push({ severity: "Error", segment: "BPR", loop: "N/A", description: "Missing Payment Information (BPR)." });
    }
    if (!segments.some(s => s.startsWith("TRN"))) {
      errors.push({ severity: "Error", segment: "TRN", loop: "N/A", description: "Missing Trace Number (TRN)." });
    }
    if (!segments.some(s => s.startsWith("N1"))) {
      errors.push({ severity: "Error", segment: "N1", loop: "1000", description: "Missing Payer / Payee (N1)." });
    }
    if (!segments.some(s => s.startsWith("CLP"))) {
      errors.push({ severity: "Error", segment: "CLP", loop: "2100", description: "Missing Claim Payment Information (CLP)." });
    }
    if (!segments.some(s => s.startsWith("CAS"))) {
      errors.push({ severity: "Warning", segment: "CAS", loop: "2100", description: "Missing Claim Adjustment segment." });
    }
    if (!segments.some(s => s.startsWith("NM1"))) {
      errors.push({ severity: "Error", segment: "NM1", loop: "2100", description: "Missing Patient Identification segment." });
    }
    if (!segments.some(s => s.startsWith("DTM"))) {
      errors.push({ severity: "Warning", segment: "DTM", loop: "2100", description: "Missing Date/Time Reference segment." });
    }
  } else if (type === "837") {
    if (!segments.some(s => s.startsWith("NM1"))) {
      errors.push({ severity: "Error", segment: "NM1", loop: "2010", description: "Missing Subscriber/Patient Name (NM1)." });
    }
    if (!segments.some(s => s.startsWith("SBR"))) {
      errors.push({ severity: "Error", segment: "SBR", loop: "2000B", description: "Missing Subscriber Information (SBR)." });
    }
    if (!segments.some(s => s.startsWith("CLM"))) {
      errors.push({ severity: "Error", segment: "CLM", loop: "2300", description: "Missing Claim Information (CLM)." });
    }

    // Specific checks for elements
    const hasN4 = segments.some(s => s.startsWith("N4"));
    if (hasN4 && segments.some(s => s.startsWith("N4") && s.split('*').length < 4)) {
      errors.push({ severity: "Error", segment: "N4", loop: "2010AA", description: "Missing N403 (Zip Code) when N401 is present." });
    }
  } else if (type === "834") {
    if (!segments.some(s => s.startsWith("INS"))) {
      errors.push({ severity: "Error", segment: "INS", loop: "2000", description: "Missing Member Level Detail (INS)." });
    }
    if (!segments.some(s => s.startsWith("NM1"))) {
      errors.push({ severity: "Error", segment: "NM1", loop: "2100A", description: "Missing Member Name Information (NM1)." });
    }
    if (!segments.some(s => s.startsWith("DTP"))) {
      errors.push({ severity: "Warning", segment: "DTP", loop: "2000", description: "Missing Member Level Dates (DTP)." });
    }
  } else {
    errors.push({ severity: "Error", segment: "ST", loop: "N/A", description: "Unknown or unsupported transaction set." });
  }

  // Generic Structural validations
  if (!segments.some(s => s.startsWith("ISA"))) {
    errors.push({ severity: "Error", segment: "ISA", loop: "Header", description: "Missing Interchange Control Header (ISA)." });
  }
  if (!segments.some(s => s.startsWith("IEA"))) {
    errors.push({ severity: "Error", segment: "IEA", loop: "Footer", description: "Missing Interchange Control Trailer (IEA)." });
  }

  if (errors.length === 0) {
    errors.push({ severity: "Success", segment: "ALL", loop: "N/A", description: "No validation errors found! File is compliant." });
  }

  return errors;
}

window.updateValidationReportUI = function (errors, fileName, transType = 'unknown') {
  ...
  const titleP = reportSection.querySelector('p.text-slate-500');
  if (titleP) {
    const errCount = errors.filter(e => e.severity !== "Success").length;

    let transName = "Unknown Format";
    if (transType === '835') transName = "835 Remittance Advice";
    if (transType === '837') transName = "837 Claim";
    if (transType === '834') transName = "834 Enrollment";

    if (errCount > 0) {
      titleP.innerHTML = `Detected ${errCount} issue(s) in ${fileName}<br><span class="text-xs font-semibold text-slate-400 mt-1 inline-block">Transaction Type: ${transName}</span>`;
    } else {
      titleP.innerHTML = `File ${fileName} is fully compliant. No issues detected.<br><span class="text-xs font-semibold text-slate-400 mt-1 inline-block">Transaction Type: ${transName}</span>`;
    }
  }
  ...
  errors.forEach(err => {
    ...
    tr.className = 'border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300 group cursor-pointer relative';
    tr.innerHTML = `
            ...
            <td class="px-6 py-4 font-medium whitespace-nowrap">${err.description}</td>
            <td class="px-6 py-4 whitespace-nowrap">
...
window.revalidateFile = function () {
  ...
  setTimeout(() => {
    const segments = window.currentUploadedFileContent.split("~").map(s => s.trim()).filter(Boolean);
    const transType = detectTransactionType(segments);
    const errors = validateEDI(segments, transType);

    window.updateValidationReportUI(errors, window.currentUploadedFileName || 'Edited File', transType);
    window.updateParsedDataUI(segments, transType, window.currentUploadedFileName || 'Edited File');
